...
# meliad_lib/meliad/transformer/configs/

_GIN_SEARCH_PATHS = ['meliad_lib/meliad/transformer/configs','/home/ubuntu/ws/alphageometry']
_GIN_FILE = ['meliad_lib/meliad/transformer/configs/base_htrans.gin', 
             'meliad_lib/meliad/transformer/configs/size/medium_150M.gin', 
             'meliad_lib/meliad/transformer/configs/options/positions_t5.gin', 
             'meliad_lib/meliad/transformer/configs/options/lr_cosine_decay.gin', 
             'meliad_lib/meliad/transformer/configs/options/seq_1024_nocache.gin',
...
def get_lm(ckpt_init: str, vocab_path: str) -> lm.LanguageModelInference:
  lm.parse_gin_configuration(
      _GIN_FILE, _GIN_PARAM, gin_paths=_GIN_SEARCH_PATHS
  )
